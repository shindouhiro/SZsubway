...
export const line5: Line = {
  ...
  stations: [
    ...
    { id: "518", name: { zh: "大学城", en: "University Town" }, toilet: { zh: "C出口附近 (需出闸)", en: "Near Exit C (Outside Gate)" }, toilets: [{ location: { zh: "C出口", en: "Near Exit C" }, exit: "C" }], surroundings: { zh: ["大学城"], en: ["University Town"] }, x: 480, y: 140 },
    { id: "519", name: { zh: "塘朗", en: "Tanglang" }, toilet: { zh: "D出口附近 (需出闸)", en: "Near Exit D (Outside Gate)" }, toilets: [{ location: { zh: "D出口", en: "Near Exit D" }, exit: "D" }], surroundings: { zh: ["塘朗"], en: ["Tanglang"] }, x: 510, y: 130 },
    { id: "520", name: { zh: "长岭陂", en: "Changlingpi" }, toilet: { zh: "C出口附近 (需出闸)", en: "Near Exit C (Outside Gate)" }, toilets: [{ location: { zh: "C出口", en: "Near Exit C" }, exit: "C" }], surroundings: { zh: ["长岭陂"], en: ["Changlingpi"] }, x: 540, y: 120 },
    {
      id: "521",
      name: { zh: "深圳北站", en: "Shenzhen North Station" },
      toilet: { zh: "站厅付费区 / 站台 (5号线)", en: "Hall Paid Area / Platform" },
      toilets: [{ location: { zh: "站厅", en: "Hall" }, exit: "—" }],
      exits: [{ id: "A", x: -40, y: -40 }, { id: "B", x: 40, y: -40 }, { id: "C", x: 40, y: 40 }, { id: "D", x: -40, y: 40 }],
      surroundings: { zh: ["深圳北站"], en: ["Shenzhen North"] },
      transfer: ["4", "6"],
      x: 670, y: 90
    },
    { id: "522", name: { zh: "民治", en: "Minzhi" }, toilet: { zh: "B出口附近 (需出闸)", en: "Near Exit B (Outside Gate)" }, toilets: [{ location: { zh: "B出口", en: "Near Exit B" }, exit: "B" }], surroundings: { zh: ["民治"], en: ["Minzhi"] }, x: 700, y: 100 },
    { id: "523", name: { zh: "五和", en: "Wuhe" }, toilet: { zh: "B出口附近 (需出闸)", en: "Near Exit B (Outside Gate)" }, toilets: [{ location: { zh: "B出口", en: "Near Exit B" }, exit: "B" }], surroundings: { zh: ["五和"], en: ["Wuhe"] }, transfer: ["10"], x: 730, y: 120 },
    { id: "524", name: { zh: "坂田", en: "Bantian" }, toilet: { zh: "A出口附近 (需出闸)", en: "Near Exit A (Outside Gate)" }, toilets: [{ location: { zh: "A出口", en: "Near Exit A" }, exit: "A" }], surroundings: { zh: ["坂田"], en: ["Bantian"] }, x: 750, y: 130 },
    { id: "525", name: { zh: "杨美", en: "Yangmei" }, toilet: { zh: "C出口附近 (需出闸)", en: "Near Exit C (Outside Gate)" }, toilets: [{ location: { zh: "C出口", en: "Near Exit C" }, exit: "C" }], surroundings: { zh: ["杨美"], en: ["Yangmei"] }, x: 770, y: 140 },
    { id: "526", name: { zh: "上水径", en: "Shangshuijing" }, toilet: { zh: "C出口附近 (需出闸)", en: "Near Exit C (Outside Gate)" }, toilets: [{ location: { zh: "C出口", en: "Near Exit C" }, exit: "C" }], surroundings: { zh: ["上水径"], en: ["Shangshuijing"] }, x: 790, y: 160 },
    { id: "527", name: { zh: "下水径", en: "Xiashuijing" }, toilet: { zh: "A出口附近 (需出闸)", en: "Near Exit A (Outside Gate)" }, toilets: [{ location: { zh: "A出口", en: "Near Exit A" }, exit: "A" }], surroundings: { zh: ["下水径"], en: ["Xiashuijing"] }, x: 810, y: 180 },
    { id: "528", name: { zh: "长龙", en: "Changlong" }, toilet: { zh: "B出口附近 (需出闸)", en: "Near Exit B (Outside Gate)" }, toilets: [{ location: { zh: "B出口", en: "Near Exit B" }, exit: "B" }], surroundings: { zh: ["长龙"], en: ["Changlong"] }, x: 830, y: 200 },
    { id: "529", name: { zh: "布吉", en: "Buji" }, toilet: { zh: "站厅付费区 / 站台", en: "Hall Paid Area / Platform" }, toilets: [{ location: { zh: "站厅", en: "Hall" }, exit: "—" }], surroundings: { zh: ["布吉"], en: ["Buji"] }, transfer: ["3", "14"], x: 1000, y: 260 },
    { id: "530", name: { zh: "百鸽笼", en: "Baigelong" }, toilet: { zh: "B出口附近 (需出闸)", en: "Near Exit B (Outside Gate)" }, toilets: [{ location: { zh: "B出口", en: "Near Exit B" }, exit: "B" }], surroundings: { zh: ["百鸽笼"], en: ["Baigelong"] }, x: 1020, y: 280 },
...
export const line6: Line = {
  ...
  color: "#34E2E2",
  stations: [
    { id: "601", name: { zh: "科学馆", en: "Science Museum" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], exits: [{ id: "A", x: -20, y: -30 }, { id: "B", x: 20, y: -30 }, { id: "C", x: 30, y: 10 }, { id: "D", x: -20, y: 30 }], surroundings: { zh: ["科学馆"], en: ["Science Museum"] }, transfer: ["1"], x: 760, y: 370 },
    { id: "602", name: { zh: "通新岭", en: "Tongxinling" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["通新岭"], en: ["Tongxinling"] }, transfer: ["3"], x: 760, y: 340 },
    { id: "603", name: { zh: "体育中心", en: "Sports Center" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["体育中心"], en: ["Sports Center"] }, x: 760, y: 310 },
    { id: "604", name: { zh: "八卦岭", en: "Bagualing" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["八卦岭"], en: ["Bagualing"] }, transfer: ["7"], x: 760, y: 280 },
    { id: "605", name: { zh: "银湖", en: "Yinhu" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["银湖"], en: ["Yinhu"] }, transfer: ["9"], x: 730, y: 250 },
    { id: "606", name: { zh: "翰岭", en: "Hanling" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["翰岭"], en: ["Hanling"] }, x: 700, y: 220 },
    { id: "607", name: { zh: "梅林关", en: "Meilinguan" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["梅林关"], en: ["Meilinguan"] }, x: 680, y: 200 },
    { id: "608", name: { zh: "深圳北站", en: "Shenzhen North Station" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["深圳北站"], en: ["Shenzhen North"] }, transfer: ["4", "5"], x: 670, y: 90 },
    { id: "609", name: { zh: "红山", en: "Hongshan" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["红山"], en: ["Hongshan"] }, transfer: ["4"], x: 670, y: 60 },
    { id: "610", name: { zh: "上芬", en: "Shangfen" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["上芬"], en: ["Shangfen"] }, x: 630, y: 60 },
    { id: "611", name: { zh: "元芬", en: "Yuanfen" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["元芬"], en: ["Yuanfen"] }, x: 590, y: 60 },
    { id: "612", name: { zh: "阳台山东", en: "Yangtai Mountain East" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["阳台山"], en: ["Yangtai Mtn"] }, x: 550, y: 60 },
    { id: "613", name: { zh: "官田", en: "Guantian" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["官田"], en: ["Guantian"] }, x: 510, y: 60 },
    { id: "614", name: { zh: "上屋", en: "Shangwu" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["上屋"], en: ["Shangwu"] }, transfer: ["13"], x: 470, y: 60 },
    { id: "615", name: { zh: "长圳", en: "Changzhen" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["长圳"], en: ["Changzhen"] }, x: 430, y: 60 },
    { id: "616", name: { zh: "凤凰城", en: "Fenghuang Town" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["凤凰城"], en: ["Fenghuang Town"] }, transfer: ["13"], x: 390, y: 60 },
    { id: "617", name: { zh: "光明大街", en: "Guangming St" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["光明大街"], en: ["Guangming St"] }, x: 350, y: 60 },
    { id: "618", name: { zh: "光明", en: "Guangming" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["光明"], en: ["Guangming"] }, transfer: ["6"], x: 310, y: 60 },
    { id: "619", name: { zh: "科学公园", en: "Science Park" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["科学公园"], en: ["Science Park"] }, x: 270, y: 60 },
    { id: "620", name: { zh: "楼村", en: "Loucun" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["楼村"], en: ["Loucun"] }, x: 230, y: 60 },
    { id: "621", name: { zh: "红花山", en: "Honghuashan" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["红花山"], en: ["Honghuashan"] }, x: 190, y: 60 },
    { id: "622", name: { zh: "公明广场", en: "Gongming Square" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["公明广场"], en: ["Gongming Sq"] }, transfer: ["13"], x: 150, y: 60 },
    { id: "623", name: { zh: "合水口", en: "Heshuikou" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["合水口"], en: ["Heshuikou"] }, x: 110, y: 60 },
  ...
  stations: [
    {
      ...
      toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" },
...
export const line8: Line = {
  ...
  stations: [
    ...
    { id: "802", name: { zh: "梧桐山南", en: "Wutong Mountain South" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["梧桐山"], en: ["Wutong Mtn"] }, x: 1000, y: 460 },
    { id: "803", name: { zh: "沙头角", en: "Shatoujiao" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["沙头角"], en: ["Shatoujiao"] }, x: 1030, y: 470 },
    { id: "804", name: { zh: "海山", en: "Haishan" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["海山"], en: ["Haishan"] }, x: 1060, y: 480 },
    { id: "805", name: { zh: "盐田港西", en: "Yantian Port West" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["盐田港"], en: ["Yantian Port"] }, x: 1090, y: 490 },
    { id: "806", name: { zh: "深外高中", en: "Shenwai Senior Campus" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["深外"], en: ["Shenwai"] }, x: 1120, y: 500 },
    { id: "807", name: { zh: "盐田路", en: "Yantian Rd" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["盐田路"], en: ["Yantian Rd"] }, x: 1150, y: 510 },
    { id: "808", name: { zh: "鸿安围", en: "Honganwei" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["鸿安围"], en: ["Honganwei"] }, x: 1180, y: 520 },
    { id: "809", name: { zh: "盐田墟", en: "Yantianxu" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["盐田墟"], en: ["Yantianxu"] }, x: 1210, y: 530 },
    { id: "810", name: { zh: "大梅沙", en: "Dameisha" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["大梅沙"], en: ["Dameisha"] }, x: 1240, y: 540 },
    { id: "811", name: { zh: "小梅沙", en: "Xiaomeisha" }, toilet: { zh: "站台两端 (付费区内)", en: "Platform Ends (Paid Area)" }, toilets: [{ location: { zh: "站台两端", en: "Platform Ends" }, exit: "—" }], surroundings: { zh: ["小梅沙"], en: ["Xiaomeisha"] }, x: 1270, y: 550 }
  ]
};
